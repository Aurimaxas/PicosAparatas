...
import lt.mikalauskas.EkranasZaliavuLikuciai.eHandler;

public class EkranasPapildytiZaliavu extends JFrame {

	JButton b1;
	JLabel l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17;
	JTextField t1, t2, t3, t4, t5, t6, t7, t8;
	String tekstasPadas, tekstasDesra, tekstasKumpis, tekstasVistiena, tekstasPievagrybiai, tekstasSuris,
			tekstasPomidorai, tekstasPadazas;
	eHandler handler = new eHandler();

	public EkranasPapildytiZaliavu(String s) {
	...
	public class eHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == b1) {
				...
				tekstasPadas = t1.getText();
				if (tekstasPadas.equals("")) {
					tekstasPadas = "0";
				}
				int padas = Integer.parseInt(tekstasPadas) + pz.getPadas();
				pz.papildytiPadu(padas);
				tekstasDesra = t2.getText();
				if (tekstasDesra.equals("")) {
					tekstasDesra = "0";
				}
				int desra = Integer.parseInt(tekstasDesra) + pz.getDesra();
				pz.papildytiDesros(desra);
				tekstasKumpis = t3.getText();
				if (tekstasKumpis.equals("")) {
					tekstasKumpis = "0";
				}
				int kumpis = Integer.parseInt(tekstasKumpis) + pz.getKumpis();
				pz.papildytiKumpio(kumpis);
				tekstasVistiena = t4.getText();
				if (tekstasVistiena.equals("")) {
					tekstasVistiena = "0";
				}
				int vistiena = Integer.parseInt(tekstasVistiena) + pz.getVistiena();
				pz.papildytiVistienos(vistiena);
				tekstasPievagrybiai = t5.getText();
				if (tekstasPievagrybiai.equals("")) {
					tekstasPievagrybiai = "0";
				}
				int pievagrybiai = Integer.parseInt(tekstasPievagrybiai) + pz.getPievagrybiai();
				pz.papildytiPievagrybiu(pievagrybiai);
				tekstasSuris = t6.getText();
				if (tekstasSuris.equals("")) {
					tekstasSuris = "0";
				}
				int suris = Integer.parseInt(tekstasSuris) + pz.getSuris();
				pz.papildytiSurio(suris);
				tekstasPomidorai = t7.getText();
				if (tekstasPomidorai.equals("")) {
					tekstasPomidorai = "0";
				}
				int pomidorai = Integer.parseInt(tekstasPomidorai) + pz.getPomidorai();
				pz.papildytiPomidoru(pomidorai);
				tekstasPadazas = t8.getText();
				if (tekstasPadazas.equals("")) {
					tekstasPadazas = "0";
				}
				int padazas = Integer.parseInt(tekstasPadazas) + pz.getPadazas();
				pz.papildytiPadazo(padazas);
